opkg update
opkg install luci-i18n-base-zh-cn wget coreutils-nohup bash luci-compat
...
wget install https://ghproxy.com/https://github.com/vernesong/OpenClash/releases/download/v0.45.59-beta/luci-app-openclash_0.45.59-beta_all.ipk
